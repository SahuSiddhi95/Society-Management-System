...
export default function Sidebar({ active, setActive, admin = {} }) {
  ...
  return (
    <aside className="fixed top-0 left-0 h-screen w-56 bg-[#3b3fa5] flex flex-col z-20">
      {/* Logo */}
      ...
      <nav className="flex-1 px-3">
        ...
        {navItems.map((item) => {
          ...
          const badgeValue = item.key === "notification" ? unreadCount : item.badge;
      ...
      {/* User + Dropdown */}
      <div className="relative px-3 pb-5" ref={ref}>
